...
const translations: Record<Lang, Record<string, string>> = {
  de: {
    ...
    "menu.extras": "Extras",
    "menu.help": "Hilfe",
    "menu.help.about": "Über WebSpeak3",
    ...
    "feedback.dialog.category": "Kategorie",
    "feedback.dialog.category.bug": "Fehler",
    "feedback.dialog.category.idea": "Idee",
    "feedback.dialog.category.report": "Meldung (Verstoß/Missbrauch)",
    "feedback.dialog.category.other": "Sonstiges",
    "feedback.dialog.reportHint": "Meldungen bleiben privat und werden nie als GitHub-Issue veröffentlicht. Gib bei Bedarf den betroffenen Server mit an.",
    "feedback.dialog.message": "Nachricht",
    "feedback.dialog.messagePlaceholder": "Was ist passiert, oder was schlägst du vor?",
    "feedback.dialog.email": "E-Mail (optional, für Rückfragen)",
    "feedback.dialog.publishAsIssue": "Als öffentliches GitHub-Issue veröffentlichen",
    "feedback.dialog.publishAsIssueHint": "Ohne Haken bleibt dein Feedback privat und geht nur an den Betreiber.",
    "feedback.dialog.publishAsIssueHintBug": "Fehlermeldungen werden immer als öffentliches GitHub-Issue veröffentlicht.",
    "feedback.dialog.send": "Senden",
    "feedback.dialog.cancel": "Abbrechen",
    "restartNotice.title": "Kurze Unterbrechung",
    "restartNotice.body": "Der Server wird gleich kurz neu gestartet. Deine Verbindung wird dabei kurz unterbrochen.",
    "restartNotice.ack": "Verstanden",
    "menu.extras.tos": "Nutzungsbedingungen",
    "tos.title": "Nutzungsbedingungen für client.webspeak3.de",
    "tos.rule1": "Dieser Client dient der privaten, nicht-kommerziellen Nutzung von TeamSpeak-/TeaSpeak-/GreenTeaSpeak-Servern über den Browser.",
    "tos.rule2": "Verboten sind insbesondere: Straftaten jeder Art, Belästigung und Hassrede, Spam und Flooding, Störung des Dienstes sowie die Umgehung von Sperren.",
    "tos.rule3": "Bei Verstößen kann der Zugang ohne Vorwarnung gesperrt werden; schwerwiegende Fälle werden ggf. an die zuständigen Behörden gemeldet.",
    "tos.rule4Pre": "Zur Betriebssicherheit und Missbrauchserkennung werden Verbindungen protokolliert (Serveradresse, Servername, Zeitpunkt) und nach 90 Tagen automatisch gelöscht – siehe ",
    "tos.rule4Post": ".",
    "tos.privacyLinkText": "Datenschutzerklärung",
    "tos.rule5Pre": "Bei Missbrauch oder Beschwerden: siehe ",
    "tos.rule5Post": ".",
    "tos.legalLinkText": "Impressum",
    "tos.rule6": "Mit Klick auf „Akzeptieren\" stimmst du diesen Bedingungen zu. Die Zustimmung wird nur lokal in deinem Browser gespeichert; bei Regeländerungen wirst du erneut gefragt.",
    "tos.accept": "Akzeptieren",
    "tos.close": "Schließen",
    "feedback.dialog.sending": "Wird gesendet…",
    "feedback.dialog.success": "Danke für dein Feedback!",
    "feedback.dialog.successWithIssue": "Danke! Issue erstellt:",
    "feedback.dialog.error": "Senden fehlgeschlagen. Bitte später erneut versuchen.",
    ...
    "publish.screen": "Bildschirm",
    "publish.starting": "Wird gestartet…",
    "publish.viewers": "{count} Zuschauer",
    "publish.request.allow": "Zulassen",
    "publish.request.deny": "Ablehnen",
    "publish.request.block": "Sperren",
    "publish.request.blockHint": "Ablehnen und nicht erneut fragen",
    "publish.dialog.title": "Stream-Einstellungen",
    "publish.dialog.basic": "Grundeinstellungen",
    "publish.dialog.advanced": "Erweiterte Einstellungen",
    "publish.dialog.golive": "Live gehen",
    "publish.dialog.cancel": "Zurück",
    "publish.preset": "Voreinstellung",
    "publish.preset.presentation": "Präsentation",
    "publish.audio": "Audio aufnehmen",
    "publish.privacy": "Privatsphäre",
    "publish.privacy.public": "Öffentlich",
    "publish.privacy.contacts": "Kontakte",
    "publish.privacy.private": "Privat",
    "publish.resolution": "Auflösung",
    "publish.res.source": "Quelle",
    "publish.fps": "FPS",
    "publish.bitrate": "Bitrate",
    "publish.audioBitrate": "Audio-Bitrate [Kbps]",
    "publish.viewerLimit": "Zuschauerbegrenzung",
    "publish.mode": "Verbindungsmodus",
    "publish.mode.p2p": "P2P",
    "publish.mode.server": "Server",
    "publish.mode.serverUnavailable": "Der Server-Modus läuft über TS6s SFU und ist noch nicht implementiert.",
  ...
  en: {
    ...
    "menu.extras": "Tools",
    "menu.help": "Help",
    "menu.help.about": "About WebSpeak3",
    "menu.help.github": "GitHub",
    "menu.help.changelog": "Changelog",
    ...
    "feedback.dialog.category": "Category",
    "feedback.dialog.category.bug": "Bug",
    "feedback.dialog.category.idea": "Idea",
    "feedback.dialog.category.report": "Report (violation/abuse)",
    "feedback.dialog.category.other": "Other",
    "feedback.dialog.reportHint": "Reports stay private and are never published as a GitHub issue. Feel free to name the affected server.",
    "feedback.dialog.message": "Message",
    "feedback.dialog.messagePlaceholder": "What happened, or what are you suggesting?",
    "feedback.dialog.email": "Email (optional, for follow-up)",
    "feedback.dialog.publishAsIssue": "Publish as a public GitHub issue",
    "feedback.dialog.publishAsIssueHint": "Leave unchecked to keep your feedback private, visible only to the maintainer.",
    "feedback.dialog.publishAsIssueHintBug": "Bug reports are always published as a public GitHub issue.",
    "feedback.dialog.send": "Send",
    "restartNotice.title": "Brief interruption",
    "restartNotice.body": "The server is about to restart briefly. Your connection will drop for a moment.",
    "restartNotice.ack": "Got it",
    "menu.extras.tos": "Terms of use",
    "tos.title": "Terms of use for client.webspeak3.de",
    "tos.rule1": "This client is for private, non-commercial use of TeamSpeak/TeaSpeak/GreenTeaSpeak servers via the browser.",
    "tos.rule2": "Prohibited in particular: any criminal activity, harassment and hate speech, spam and flooding, disrupting the service, and circumventing bans.",
    "tos.rule3": "Violations may result in access being blocked without warning; serious cases may be reported to the relevant authorities.",
    "tos.rule4Pre": "For operational security and abuse detection, connections are logged (server address, server name, timestamp) and automatically deleted after 90 days – see the ",
    "tos.rule4Post": ".",
    "tos.privacyLinkText": "privacy policy",
    "tos.rule5Pre": "For abuse or complaints: see the ",
    "tos.rule5Post": ".",
    "tos.legalLinkText": "legal notice (Impressum)",
    "tos.rule6": "By clicking \"Accept\" you agree to these terms. Your acceptance is stored only locally in your browser; you'll be asked again if the rules change.",
    "tos.accept": "Accept",
    "tos.close": "Close",
    "feedback.dialog.cancel": "Cancel",
    "feedback.dialog.sending": "Sending…",
    "feedback.dialog.success": "Thanks for your feedback!",
    "feedback.dialog.successWithIssue": "Thanks! Issue created:",
    "feedback.dialog.error": "Failed to send. Please try again later.",
    ...
    "publish.viewers": "{count} watching",
    "publish.request.allow": "Allow",
    "publish.request.deny": "Deny",
    "publish.request.block": "Block",
    "publish.request.blockHint": "Deny and stop asking",
    "publish.dialog.title": "Stream settings",
    "publish.dialog.basic": "Basic settings",
    "publish.dialog.advanced": "Advanced settings",
    "publish.dialog.golive": "Go live",
    "publish.dialog.cancel": "Back",
    "publish.preset": "Preset",
    "publish.preset.presentation": "Presentation",
    "publish.audio": "Capture audio",
    "publish.privacy": "Privacy",
    "publish.privacy.public": "Public",
    "publish.privacy.contacts": "Contacts",
    "publish.privacy.private": "Private",
    "publish.resolution": "Resolution",
    "publish.res.source": "Source",
    "publish.fps": "FPS",
    "publish.bitrate": "Bitrate",
    "publish.audioBitrate": "Audio bitrate [Kbps]",
    "publish.viewerLimit": "Viewer limit",
    "publish.mode": "Connection mode",
    "publish.mode.p2p": "P2P",
    "publish.mode.server": "Server",
    "publish.mode.serverUnavailable": "Server mode goes through TS6's SFU and is not implemented yet.",
