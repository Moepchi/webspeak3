...
const translations: Record<Lang, Record<string, string>> = {
  de: {
    ...
    "tos.rule4": "Zur Betriebssicherheit und Missbrauchserkennung werden Verbindungen protokolliert (Serveradresse, Servername, Zeitpunkt) – siehe Datenschutzerklärung.",
    "tos.rule5": "Bei Missbrauch oder Beschwerden: siehe Impressum.",
  ...
  en: {
    ...
    "tos.rule4": "For operational security and abuse detection, connections are logged (server address, server name, timestamp) – see the privacy policy.",
    "tos.rule5": "For abuse or complaints: see the legal notice (Impressum).",
