...
const copy = {
  de: {
    ...
    installKicker: "IN MINUTEN STARTKLAR", installTitle: "Dein Server. Dein WebSpeak3.", installText: "Mit Docker läuft dein eigener Browser-Client in einem einzigen Befehl.", installSteps: [["01", "Container starten", "Image laden und Port 8080 veröffentlichen."], ["02", "Browser öffnen", "WebSpeak3 lokal oder über deine Domain aufrufen."], ["03", "Server verbinden", "TS-Adresse und Nickname eingeben – fertig."]], installGuide: "Installationsanleitung", copyCommand: "Befehl kopieren", copied: "Kopiert!",
    faqKicker: "GUT ZU WISSEN", faqTitle: "Fragen, bevor du loslegst.", faqs: [["Brauche ich einen neuen TeamSpeak-Server?", "Nein. WebSpeak3 verbindet sich mit deinem bestehenden TS3- oder TS6-Server; daran muss nichts verändert werden."], ["Wo laufen meine Sprachdaten?", "Über dein selbst gehostetes Gateway und den Rust Connector direkt zu deinem TeamSpeak-Server – ohne fremde WebSpeak3-Cloud."], ["Welche Browser werden unterstützt?", "Moderne Chromium- und Firefox-Browser sind das Hauptziel. Einzelne Audiofunktionen können je nach Browser und Gerät abweichen."], ["Benötigt WebSpeak3 Zugriff auf mein Mikrofon?", "Erst wenn du das Mikrofon aktivierst. Dann fragt der Browser wie üblich nach deiner Erlaubnis."], ["Ist das Projekt produktionsreif?", "WebSpeak3 ist aktuell als Beta beziehungsweise Prototyp gekennzeichnet. Teste deine gewünschte Umgebung daher vor einem breiten Einsatz."], ["Kann ich mithelfen?", "Ja. Fehlerberichte, Ideen und Beiträge sind über das öffentliche GitHub-Repository willkommen."]],
  ...
  en: {
    ...
    installKicker: "READY IN MINUTES", installTitle: "Your server. Your WebSpeak3.", installText: "Run your own browser client with a single Docker command.", installSteps: [["01", "Start the container", "Pull the image and publish port 8080."], ["02", "Open your browser", "Visit WebSpeak3 locally or through your domain."], ["03", "Connect your server", "Enter your TS address and nickname — done."]], installGuide: "Installation guide", copyCommand: "Copy command", copied: "Copied!",
    faqKicker: "GOOD TO KNOW", faqTitle: "Questions before you start.", faqs: [["Do I need a new TeamSpeak server?", "No. WebSpeak3 connects to your existing TS3 or TS6 server; no server changes are required."], ["Where does my voice data go?", "Through your self-hosted gateway and Rust connector directly to your TeamSpeak server — without a third-party WebSpeak3 cloud."], ["Which browsers are supported?", "Modern Chromium and Firefox browsers are the main targets. Individual audio features may vary by browser and device."], ["Does WebSpeak3 need microphone access?", "Only when you enable the microphone. Your browser will then ask for permission as usual."], ["Is the project production-ready?", "WebSpeak3 is currently marked as a beta/prototype. Test your intended environment before rolling it out broadly."], ["Can I contribute?", "Yes. Bug reports, ideas and contributions are welcome through the public GitHub repository."]],
